...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, default='./abc_weights/ECA/config.yaml')
    ...
    parser.add_argument('--dataset_name', type=str, default='FamousTest')
    parser.add_argument("--dataset_root", type=str, default='../new_datasets')
    parser.add_argument("--gen_resolution_global", type=int, default=256)
