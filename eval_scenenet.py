...
parser.add_argument("--gendir", type=str, help="Path to generated data", default='./pred_result/SceneNet/SA1/gen_SceneNet20_test_allPts/')
parser.add_argument("--gtdir", type=str, help="Path to ground truth data", default='../SceneNet/SceneNet20/')
parser.add_argument("--meshdir", type=str, default="meshes")
parser.add_argument("--filter", type=str, default=None)
parser.add_argument("--npoints", type=int, default=2000000)
parser.add_argument("--Fthreshold", type=float, default=0.02)
...
def process_meshes(source_filename, F_threshold):
    ...
    print(f"{os.getppid()} - {os.getpid()} - {category} - {fname} - done procesing")
    return out_dict
