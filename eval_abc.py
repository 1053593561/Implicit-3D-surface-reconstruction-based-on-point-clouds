...
parser.add_argument("--gendir", type=str, help="Path to generated data", default='./pred_result/ABC/ECA/gen_ABCTest/meshes/04_pts/')
parser.add_argument("--gtdir", type=str, help="Path to ground truth data", default='./new_datasets/3d_shapes_abc/abc/03_meshes/')
...
if __name__ == "__main__":
    ...
    out_file_class = os.path.join('./eval_results/eval_abc_%s.csv'%args.gendir.split('/')[3])
