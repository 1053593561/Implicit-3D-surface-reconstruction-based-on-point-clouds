...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, default='./shapenet_normal_weights/ECA/config.yaml')
    ...
    parser.add_argument('--dataset_name', type=str, default='SceneNet20')
    parser.add_argument("--dataset_root", type=str, default='../SceneNet/SceneNet20/')
    parser.add_argument("--gen_resolution_global", type=int, default=128)
    ...
    config["gen_autoscale_target"] = 0.01
    config["gen_autoscale"] = True
    config["gen_resolution_metric"] = 0.01
    config["manifold_points"]=-1
