...
parser.add_argument("--gendir", type=str, help="Path to generated data", default='./pred_result/Famous/baseline/gen_FamousTest/meshes/04_pts/')
parser.add_argument("--gtdir", type=str, help="Path to ground truth data", default='./new_datasets/famous_original/03_meshes/')
...
if __name__ == "__main__":
    ...
    out_file_class = os.path.join('./eval_results/eval_famous_%s.csv'%args.gendir.split('/')[3])
