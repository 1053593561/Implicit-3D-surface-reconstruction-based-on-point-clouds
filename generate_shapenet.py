...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, default='shapenet_weights/ECA/config.yaml')
    ...
    parser.add_argument("--dataset_root", type=str, default='../dataset_small_v1.1/ShapeNet')
