...
if __name__ == "__main__":
    ...
    parser.add_argument("--gendir", type=str, help="Path to generated data", default='./pred_results/Shapenet/baseline/meshes')
    parser.add_argument("--gtdir", type=str, help="Path to ground truth data", default='../dataset_small_v1.1/ShapeNet')
    parser.add_argument("--dataset", type=str, help="Dataset name", default="ShapeNet")
